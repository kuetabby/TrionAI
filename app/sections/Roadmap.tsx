...
const roadmapData: RoadmapPhase[] = [
  ...
  {
    phase: "Phase 2",
    title: "AI Sports Development",
    description:
      "Building the core AI sports engine with advanced machine learning capabilities.",
    features: [
      "AI sports logic implementation",
  ...
  },
  {
    ...
    description:
      "Improving user interface and adding advanced sports features for better engagement.",
    features: [
      "Advanced UI/UX design",
      "Multi-sports support",
      "Social features integration",
      "Mobile app developement for iOS and Android",
